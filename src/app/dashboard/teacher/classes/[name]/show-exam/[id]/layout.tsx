...
export default async function ShowExamLayout({
  params,
  children,
}: {
    ...
    <div className="flex flex-col gap-4 sm:px-10 px-3 text-sm">
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Link
            className="px-4 py-2 bg-white font-medium text-black rounded-md"
            href={`/dashboard/teacher/classes/${name}/show-exam/${id}/submissions`}>
