      ...
      <motion.button
        ...
        <SwitchPrimitives.Thumb asChild>
          <motion.div
            ...
            whileTap="tab"
            className={cn(
              "relative z-[1] [&_svg]:size-3 flex items-center justify-center rounded-full data-[state=checked]:bg-Second-black data-[state=unchecked]:bg-white shadow-lg ring-0 dark:text-neutral-400 text-neutral-500"
            )}
            layout
