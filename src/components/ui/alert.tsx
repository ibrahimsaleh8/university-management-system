  ...
  "flex items-stretch w-full gap-2 group-[.toaster]:w-(--width)",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        appearance: "light",
        className:
          "bg-error-red border border-error-red text-red-500 [&_[data-slot=alert-icon]]:text-destructive dark:bg-[var(--color-destructive-soft,var(--color-red-950))] dark:border-[var(--color-destructive-alpha,var(--color-red-900))] ",
      },
      {
        variant: "success",
        appearance: "light",
