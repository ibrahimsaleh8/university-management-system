  ...
  "inline-flex items-center justify-center border border-transparent font-medium focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        success:
          "bg-glass-green text-[var(--color-success-foreground,var(--color-white))]",
        warning:
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "success",
        appearance: "light",
        className: "text-green-500 bg-glass-green",
      },
      {
        variant: "warning",
        appearance: "light",
        className: "bg-glass-orange text-amber-300",
      },
      {
        variant: "info",
        appearance: "light",
      ...
      },
      {
        variant: "destructive",
        appearance: "light",
        className: "text-red-500 bg-glass-red",
      },
      /* Outline */
      {
        variant: "primary",
